...
<body class="h-screen flex flex-col">
  ...
  <div class="container mx-auto flex-1 flex flex-col">
    <h1 class="text-3xl font-bold text-brand-500 mb-3">Privacy Policy</h1>
    <p class="text-lg font-medium">We are taking our visitor's privacy serious. This document provides an overview of what data 
        gets collected and stored and how it is used.</p>
    <h2 class="text-brand-500 font-semibold text-lg mt-7">What we collect</h2>
    <p>Personal information we store is an email address during the sign-up process. If you wish to delete your account, please contact me under jennyxscharinger@gmail.com</p>
    <h2 class="text-brand-500 font-semibold text-lg mt-4">Cookies</h2>
    <p>We store session cookies which are saved only during your stay on our website. This ensures that you are staying logged in while browsing.</p>
    <h2 class="text-brand-500 font-semibold text-lg mt-4">Consent</h2>
    <p>By using our service, you agree to our privacy policy.</p>
  </div>
