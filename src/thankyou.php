...
<body>
    ...
    <h1 class="text-3xl font-bold text-brand-500 mb-3">Thank you for signing up!</h1>
      <h2 class="text-lg">Please verify your email address via the verification email we have sent you.</h2>
    </div>
